...
public class FeedPage : MonoBehaviour
{
    ...
    private void Build()
    {
        ...
        Text title = UIFactory.CreateText("Title", transform, "Feed", 28, FontStyle.Bold, UIFactory.Ink, TextAnchor.MiddleCenter);
        UIFactory.SetAnchored(title.rectTransform, new Vector2(0f, 1f), new Vector2(1f, 1f), new Vector2(24f, -104f), new Vector2(-24f, -36f));

        Text placeholder = UIFactory.CreateText("Placeholder", transform, "Feed Page Coming Soon", 18, FontStyle.Normal, UIFactory.MutedInk, TextAnchor.MiddleCenter);
